...
<p>Para aceitar nosso convite e começar sua jornada conosco, basta clicar em <a href="{{ $link_accept }}" target="_blank">Aceitar Convite</a> ou copiando a url <strong>{{ $link_accept }}</strong> e colando no navegador.</p>
