                        ...
                        <div id="default-tab-content">
                            ...
                            <div x-show="activeTab === 'dados'" class="p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="dados" role="tabpanel" aria-labelledby="dados-tab">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <x-select label="Tipo de Empresa" placeholder="Selecione um Tipo" :options="$array_tipos_empresas" option-label="name" option-value="id" wire:model.defer="form.id_tipo_empresa" />
                            ...
                            <div class="flex justify-center gap-x-3">
                                <div class="mt-3">
                                    <x-button flat label="Cancelar" class="w-24" href="{{ route('admin.empresas.index') }}" wire:navigate />
