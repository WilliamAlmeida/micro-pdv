        ...
        @else
            <div class="flex-grow">
                <div x-data="{
                    ...
                    onEscape() {
                        if(this.pesquisaProduto !== '') { this.pesquisaProduto = ''; return; }
                        $wire.escape_pesquisar_produto();
                    },
                    onSlash() {
                        this.pesquisaProduto = '';
                        $wire.encerrar_venda();
                    ...
                    x-on:keyup.enter="onEnter"  x-on:keyup.escape="onEscape" x-on:keyup.slash="onSlash"
                    />
                </div>
            </div>
        @endif
