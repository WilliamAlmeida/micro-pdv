<div>
    <x-modal.card title="Cadastro de Cliente" blur wire:model.defer="clienteCreateModal" max-width="3xl">
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <x-select label="Convênio" placeholder="Selecione um Convênio" :options="$array_convenios" option-label="nome_fantasia" option-value="id" wire:model.defer="form.id_convenio" />
