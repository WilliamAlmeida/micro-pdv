...
final class RoleTable extends PowerGridComponent
{
    ...
    public function addColumns(): PowerGridColumns
    {
        return PowerGrid::columns()
            ...
            ->addColumn('name')
            ->addColumn('used_where', function (Role $model) {
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Função', 'name')->sortable()->searchable(),
            Column::make('Usuários', 'users_count')->sortable(),
            Column::make('Permissões', 'permissions_count')->sortable(),
    ...
    public function delete($rowId, $params=null): void
    {
        ...
        if($params == null) {
            $this->dialog()->confirm([
                ...
                'description' => 'Deletar esta função?',
        ...
        try {
            ...
            $this->notification([
                ...
                'description' => 'Função foi deletada com sucesso',
                'icon'        => 'success'
            ]);
            ...
            $this->notification([
                ...
                'description' => 'Não foi possivel deletar a Função.',
                'icon'        => 'error'
            ]);
        }
    }

    public function actions(\Spatie\Permission\Models\Role $row): array
    {
        return [
            Button::add('edit')
                ->slot('Editar')
