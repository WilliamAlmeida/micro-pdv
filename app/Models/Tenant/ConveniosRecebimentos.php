...
class ConveniosRecebimentos extends Model
{
    ...
    {
        return $this->hasMany('App\Models\Tenant\ConveniosItens','convenios_recebimentos_id','id');
    }

    public function pagamentos()
    {
        return $this->hasMany('App\Models\Tenant\ConveniosPagamentos','convenios_recebimentos_id','id');
    }
}